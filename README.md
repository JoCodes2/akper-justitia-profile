# 🌐 Website Profil Akademi Keperawatan Justitia

Repository ini berisi source code Website Profil **Akademi Keperawatan Justitia**.  
Website ini menampilkan informasi kampus, program studi, galeri kegiatan, fasilitas, dan profil institusi dengan tampilan modern menggunakan **React + TailwindCSS** di sisi frontend serta **Laravel (Composer)** di sisi backend.
