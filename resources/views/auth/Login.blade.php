...
<body class="p-4">
    ...
    <div class="login-card w-full max-w-md rounded-2xl overflow-hidden login-animate-fade-in-up">
        ...
        <div class="login-gradient-header p-8 text-center relative">
            ...
            <!-- Logo -->
            <div class="login-logo-container inline-flex items-center justify-center w-24 h-24 bg-white rounded-full mb-6 relative z-10 overflow-hidden">
                <img src="{{ asset('assets/image/logo-universitas.jpeg') }}" alt="Logo" class="w-16 h-16 object-contain">
            </div>
        ...
        <!-- Form Section -->
        <div class="p-8">
            <form class="space-y-6"  method="POST" enctype="multipart/form-data" autocomplete="off" novalidate="novalidate" id="formLogin">
                @csrf
                <!-- Username Field -->
                <div class="relative login-animate-fade-in-up login-animate-delay-1">
                    <div class="login-input-container absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div class="mt-8 pt-6 border-t border-gray-100 text-center login-animate-fade-in-up">
                <p class="text-sm text-gray-500">
                    ...
                    <br>
                    <span class="text-xs text-gray-400">v1.0.0 • Secure Access</span>
                </p>
            </div>
        </div>
    </div>
