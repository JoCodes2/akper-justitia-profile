...
const Footer = () => {
    ...
    return (
        <footer className="bg-gradient-to-b from-[#1a1f29] to-[#0f131a] text-gray-300 font-body">
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm">
                        <li className="flex items-start">
                            <svg
                                className="w-5 h-5 mr-3 mt-0.5 text-primary flex-shrink-0"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
                        ...
                        <li className="flex items-start">
                            ...
                            >
                                <path
                                    ...
                                    strokeLinejoin="round"
                                    strokeWidth={2}
                                    d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 极速赛车开奖直播 极速赛车开奖直播 极速赛车开奖直播 11.009 11.009 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"
                                />
                            </svg>
                            <a
                        ...
                        <li className="flex items-start">
                            ...
                            >
                                ...
                                <path
                                    ...
                                    strokeLinejoin="round"
                                    strokeWidth={2}
                                    d="M15 11a3 3 极速赛车开奖直播 0 11-6 0 3 3 0 016 0z"
                                />
                            </svg>
                            <span className="text-gray-400">
